---
title: "Regression Analysis with tidysl"
author: "tidysl Team"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Regression Analysis with tidysl}
...
This vignette demonstrates how to use the `tidysl` package for regression analysis. The `tidysl` package provides a consistent interface for various supervised learning methods following tidyverse principles.
...
`tidysl` provides various visualization functions:
...
This vignette demonstrated how to use the `tidysl` package for regression analysis. The package provides a consistent interface for various supervised learning methods, making it easy to try different approaches and compare their performance.
